...
def Make_user_config(pCO2_start, pCO2_end):
	f=open("JG.Scot390M."+pCO2_start+"_to_"+pCO2_end+"X_1.25PO4_0.7O2.SPIN",'w')
	f.write("# *******************************************************************\n")
	f.write("# *** USERCONFIG for JG.Scot390M."+pCO2_start+"_to_"+pCO2_end+"X_1.25PO4_0.7O2.SPIN *******\n")
	f.write("# *******************************************************************\n")
        f.write("#\n")
        f.write("# *** CLIMATE *******************************************************\n")
        f.write("#\n")
	...
	f.write("# *** common settings ***********************************************\n")
        ...
        f.write("bg_par_infile_slice_name='save_timeslice_EVERY000100.dat'\n")
        ...
        f.write("bg_par_forcing_name=\"JG.DEVO_0.7O2_"+pCO2_start+"_to_"+pCO2_end+"X_5000\"\n")
        f.write("#bg_par_atm_force_scale_val_3=280.0E-06\n")
        ...
        f.write("bg_ocn_init_8=2.69875E-06\n")
        f.write("#\n")
	...
	f.write("ea_par_orbit_oscsob=0.3907311 # sine of obliquity\n")
...
pCO2 = ["01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12", "13", "14", "15", "16"]

for i in range(len(pCO2)-1):
    Make_user_config(pCO2[i], pCO2[i+1])	

for i in range(len(pCO2)-1):
    Make_user_config(pCO2[-1-i], pCO2[-1-i-1])
