...
def Make_user_config(pCO2_start, pCO2_end):
	f=open("JG.Scot390M."+pCO2_start+"_to_"+pCO2_end+"X_1.25PO4_0.7O2_go.SPIN",'w')
	f.write("# *******************************************************************\n")
	f.write("# *** USERCONFIG for JG.Scot390M."+pCO2_start+"_to_"+pCO2_end+"X_1.25PO4_0.7O2_go.SPIN ****\n")
	f.write("# *******************************************************************\n")
        f.write("#\n")
        f.write("# *** CLIMATE *******************************************************\n")
        f.write("#\n")
