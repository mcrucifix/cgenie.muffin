...
def Make_user_config(pCO2_start, pCO2_end):
	f=open("JG.Scot390M."+pCO2_start+"_to_"+pCO2_end+"X_1.25PO4_0.7O2_back.SPIN",'w')
	f.write("# *******************************************************************\n")
	f.write("# *** USERCONFIG for JG.Scot390M."+pCO2_start+"_to_"+pCO2_end+"X_1.25PO4_0.7O2_back.SPIN **\n")
	f.write("# *******************************************************************\n")
        f.write("#\n")
        f.write("# *** CLIMATE *******************************************************\n")
        f.write("#\n")
	...
	f.write("# *** common settings ***********************************************\n")
        ...
        f.write("bg_par_forcing_name=\"JG.DEVO_0.7O2_"+pCO2_start+"X\"\n")
...
for i in range(len(pCO2)):
    Make_user_config(pCO2[i], pCO2[i])	
