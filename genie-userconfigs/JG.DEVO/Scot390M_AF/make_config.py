...
def Make_user_config(ecc, obli, prec):
	f=open("JG.Scot390M.04_to_TIP_1.25PO4_0.9O2."+str(ecc)+"_"+str(obli)+"_"+str(prec)+".SPIN",'w')
	f.write("# *******************************************************************\n")
	f.write("# * USERCONFIG for JG.Scot390M.04_to_TIP_1.25PO4_0.9O2."+str(ecc)+"_"+str(obli)+"_"+str(prec)+".SPIN *\n")
	f.write("# *******************************************************************\n")
        f.write("#\n")
        f.write("# *** CLIMATE *******************************************************\n")
        f.write("#\n")
	...
	f.write("# *** common settings ***********************************************\n")
        ...
        f.write("bg_par_forcing_name=\"JG.DEVO_0.9O2\"\n")
        f.write("bg_par_atm_force_scale_val_3=616.0E-06\n")
...
ecc = [0.02, 0.04, 0.06]
prec = [0, 30, 60, 90, 120, 150, 180, 210, 240, 270, 300, 330]
obli = [22, 23.25, 24.5]
