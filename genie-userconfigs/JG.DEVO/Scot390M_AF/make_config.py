...
obli_dic = {21:"0.3583679", 22:"0.3746066", 23:"0.3907311"}

def Make_user_config(pCO2, ecc, obli, prec):
	f=open("JG.Scot390M."+pCO2+"X_1.25PO4_0.7O2."+str(ecc)+"_"+str(obli)+"_"+str(prec)+".SPIN",'w')
	f.write("# *******************************************************************\n")
	f.write("# * USERCONFIG for JG.Scot390M."+pCO2+"X_1.25PO4_0.7O2."+str(ecc)+"_"+str(obli)+"_"+str(prec)+".SPIN *\n")
	f.write("# *******************************************************************\n")
        f.write("#\n")
        f.write("# *** CLIMATE *******************************************************\n")
        f.write("#\n")
	...
	f.write("# *** common settings ***********************************************\n")
        ...
        f.write("bg_par_forcing_name=\"JG.DEVO_0.7O2_"+pCO2+"X\"\n")
...
pCO2 = ["1.9", "2.0", "2.1"]
ecc = [0.03, 0.06]
prec = [0, 45, 90, 135, 180, 225, 270, 315]
obli = [21,22,23]
...
for CO2 in pCO2:
    for i in ecc:
        for j in obli:
            for k in prec:
	        Make_user_config(CO2, i, j, k)		
    Make_user_config(CO2, 0, 21, 0)
    Make_user_config(CO2, 0, 22, 0)
    Make_user_config(CO2, 0, 23, 0)
