...
def Make_user_config(pCO2_start):
	f=open("JG.Scot420M."+pCO2_start+"X_1.00PO4_0.4O2.SPIN",'w')
	f.write("# *******************************************************************\n")
	f.write("# *** USERCONFIG for JG.Scot420M."+pCO2_start+"X_1.00PO4_0.4O2.SPIN *******\n")
	f.write("# *******************************************************************\n")
        f.write("#\n")
        f.write("# *** CLIMATE *******************************************************\n")
        f.write("#\n")
	...
	f.write("# *** common settings ***********************************************\n")
        ...
        f.write("bg_par_forcing_name=\"JG.DEVO_0.4O2_"+pCO2_start[6:]+"X\"\n")
