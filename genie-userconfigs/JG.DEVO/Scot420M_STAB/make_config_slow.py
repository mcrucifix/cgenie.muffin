...
def Make_user_config(pCO2_start):
	f=open("JG.Scot420M."+pCO2_start+"X_1.00PO4_0.4O2_slow.SPIN",'w')
	f.write("# *******************************************************************\n")
	f.write("# ** USERCONFIG for JG.Scot420M."+pCO2_start+"X_1.00PO4_0.4O2_slow.SPIN ***\n")
	f.write("# *******************************************************************\n")
        f.write("#\n")
        f.write("# *** CLIMATE *******************************************************\n")
        f.write("#\n")
	...
	f.write("# *** common settings ***********************************************\n")
        ...
        f.write("bg_par_forcing_name=\"JG.DEVO_0.4O2_"+pCO2_start+"X_5000\"\n")
...
pCO2 = ["02_to_08", "04_to_08", "06_to_08", "08_to_08", "10_to_08", "12_to_08", "14_to_08", "16_to_08", "18_to_08", "20_to_08"]

for i in range(len(pCO2)):
    Make_user_config(pCO2[i])

pCO2 = ["02_to_16", "04_to_16", "06_to_16", "08_to_16", "10_to_16", "12_to_16", "14_to_16", "16_to_16", "18_to_16", "20_to_16"]
