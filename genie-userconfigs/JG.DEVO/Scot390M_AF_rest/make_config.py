...
def Make_user_config(ecc, obli, prec):
	f=open("JG.Scot390M.04X_1.00PO4_0.3O2."+str(ecc)+"_"+str(obli)+"_"+str(prec)+".rest.SPIN",'w')
	f.write("# *******************************************************************\n")
	f.write("# * USERCONFIG for JG.Scot390M.04X_1.00PO4_0.3O2."+str(ecc)+"_"+str(obli)+"_"+str(prec)+".rest.SPIN *\n")
	f.write("# *******************************************************************\n")
        f.write("#\n")
        f.write("# *** CLIMATE *******************************************************\n")
        f.write("#\n")
