...
def Make_user_config(pCO2_start):
	f=open("JG.Scot390M."+pCO2_start+"_to_08X_1.00PO4_0.4O2_slow.SPIN",'w')
	f.write("# *******************************************************************\n")
	f.write("# ** USERCONFIG for JG.Scot390M."+pCO2_start+"_to_08X_1.00PO4_0.4O2_slow.SPIN ***\n")
	f.write("# *******************************************************************\n")
        f.write("#\n")
        f.write("# *** CLIMATE *******************************************************\n")
        f.write("#\n")
	...
	f.write("# *** common settings ***********************************************\n")
        ...
        f.write("bg_par_forcing_name=\"JG.DEVO_0.4O2_"+pCO2_start+"_to_08X_5000\"\n")
...
pCO2 = ["02", "04", "06", "08", "10", "12", "14", "16", "18", "20"]
