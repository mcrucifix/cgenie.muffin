...
def Make_user_config(pCO2_start, pCO2_end):
	f=open("JG.Scot420M."+pCO2_start+"_to_"+pCO2_end+"X_1.00PO4_0.4O2_go.SPIN",'w')
	f.write("# *******************************************************************\n")
	f.write("# *** USERCONFIG for JG.Scot420M."+pCO2_start+"_to_"+pCO2_end+"X_1.00PO4_0.4O2_go.SPIN ****\n")
	f.write("# *******************************************************************\n")
        f.write("#\n")
        f.write("# *** CLIMATE *******************************************************\n")
        f.write("#\n")
