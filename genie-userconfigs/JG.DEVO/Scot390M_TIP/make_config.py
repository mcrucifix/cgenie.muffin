...
def Make_user_config(pCO2):
	f=open("JG.Scot390M."+pCO2+"X_1.25PO4_0.7O2.SPIN",'w')
	f.write("# *******************************************************************\n")
	f.write("# *** USERCONFIG for JG.Scot390M."+pCO2+"X_1.25PO4_0.7O2.SPIN ******\n")
	f.write("# *******************************************************************\n")
        f.write("#\n")
        f.write("# *** CLIMATE *******************************************************\n")
        f.write("#\n")
...
pCO2 = ["04_to_2.2", "04_to_2.1", "04_to_2.0", "04_to_1.9", "04_to_1.8"]

for i in pCO2:
    Make_user_config(i)		

pCO2 = ["2.2", "2.1", "2.0", "1.9", "1.8"]
