...
def Make_user_config(plus):
	f=open("JG.Scot390M.01X_1.25PO4_0.8O2_plus_"+plus+".SPIN",'w')
	f.write("# *******************************************************************\n")
	f.write("# *** USERCONFIG for JG.Scot390M.01X_1.25PO4_0.8O2_plus_"+plus+".SPIN ***\n")
	f.write("# *******************************************************************\n")
        f.write("#\n")
        f.write("# *** CLIMATE *******************************************************\n")
        f.write("#\n")
	...
	f.write("# *** common settings ***********************************************\n")
        ...
        f.write("bg_par_forcing_name=\"JG.DEVO_0.8O2\"\n")
