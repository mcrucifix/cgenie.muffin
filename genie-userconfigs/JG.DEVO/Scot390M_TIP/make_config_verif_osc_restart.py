...
def Make_user_config(plus):
	f=open("JG.Scot390M.01_to_02X_1.25PO4_0.8O2_from_plus_"+plus+".SPIN",'w')
	f.write("# *******************************************************************\n")
	f.write("# *** USERCONFIG for JG.Scot390M.01_to_02X_1.25PO4_0.8O2_from_plus_"+plus+".SPIN *\n")
	f.write("# *******************************************************************\n")
        f.write("#\n")
        f.write("# *** CLIMATE *******************************************************\n")
        f.write("#\n")
	...
	f.write("# *** common settings ***********************************************\n")
        ...
        f.write("bg_par_infile_slice_name='save_timeslice_EVERY010000.dat'\n")
        ...
        f.write("bg_par_forcing_name=\"JG.DEVO_0.8O2_01_to_02X_5000\"\n")
...
plus = ["200", "400", "600", "800", "1000", "1200", "1400", "1600", "1800", "2000"]
