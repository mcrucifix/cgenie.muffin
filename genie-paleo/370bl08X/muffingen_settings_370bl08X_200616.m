...
%
par_wor_name='370bl08X';       % ['STRING'] 8-char (output) config name
par_gcm='foam';                 % ['STRING'] input format/GCM name
par_expid='370bl_1326.24W_EccN_2240ppm';% ['STRING'] input experiment/data name
%
% *** FILE PATHS ******************************************************** %
%
...
par_nc_atmos_name = '370bl_1326.24W_EccN_atmos_2240ppm';        % ['STRING'] optional .nc name
par_nc_ocean_name = '370bl_1326.24W_EccN_coupl_2240ppm';        % ['STRING'] optional .nc name
par_nc_coupl_name = '370bl_1326.24W_EccN_coupl_2240ppm';        % ['STRING'] optional .nc name
%
% *** GRID RESOLUTION *************************************************** %
%
